# Attachment Carousel- Frontend Code

This directory contains the frontend code for the Attachment Carousel plugin.
...
This will compile the frontend into the `../attachment_carousel/static` directory (ready for distribution).
