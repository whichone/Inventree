 ...
 */
function AttachmentCarouselPanel({
    context
}: {
    ...
    return (
        ...
        {editPartForm.modal}
        <Stack gap="xs">
        <Title c={context.theme.primaryColor}  order={3}>Attachment Carousel</Title>
        <Text>
            This is a custom panel for the AttachmentCarousel plugin.
        </Text>
